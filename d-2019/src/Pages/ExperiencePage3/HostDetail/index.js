      ...
      return (
        <Fragment>
          <Container>
              ...
              <CardImg top width="50%" src={require('../../../static/img/Phyllis.jpg')} alt="Card image cap" />
                <h3>Host: Phyllis </h3>
                <h5><a className='color_email1' href="mailto:phyllis@chicagofoodways.com">Contact Me</a></h5>
                <div>
